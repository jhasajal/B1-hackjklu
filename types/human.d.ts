...
): Promise<[void, void, void, void, void] | null>;
...
export declare type BackendEnum =
  | ""
  | "cpu"
  | "wasm"
  | "webgl"
...
export declare type BodyAnnotation =
  | BodyAnnotationBlazePose
  | BodyAnnotationEfficientPose;

export declare type BodyAnnotationBlazePose =
  | "leftLeg"
  | "rightLeg"
  | "torso"
  | "leftArm"
...
export declare type BodyAnnotationEfficientPose =
  | "leftLeg"
  | "rightLeg"
  | "torso"
  | "leftArm"
...
/** body gesture type */
export declare type BodyGesture =
  | `leaning ${"left" | "right"}`
...
export declare type BodyLandmark =
  | BodyLandmarkPoseNet
  | BodyLandmarkMoveNet
  | BodyLandmarkEfficientNet
  | BodyLandmarkBlazePose;

export declare type BodyLandmarkBlazePose =
  | "nose"
  | "leftEyeInside"
  | "leftEye"
  | "leftEyeOutside"
...
export declare type BodyLandmarkEfficientNet =
  | "head"
  | "neck"
  | "rightShoulder"
  | "rightElbow"
...
export declare type BodyLandmarkMoveNet =
  | "nose"
  | "leftEye"
  | "rightEye"
  | "leftEar"
...
export declare type BodyLandmarkPoseNet =
  | "nose"
  | "leftEye"
  | "rightEye"
  | "leftEar"
...
/** face gesture type */
export declare type FaceGesture =
...
export declare type FaceLandmark =
  | "leftEye"
  | "rightEye"
  | "nose"
  | "mouth"
...
export declare type FingerDirection =
  | "verticalUp"
  | "verticalDown"
  | "horizontalLeft"
  | "horizontalRight"
...
/** hand gesture type */
export declare type HandGesture =
...
/** iris gesture type */
export declare type IrisGesture =
  | "facing center"
...
declare namespace match {
  export { distance, similarity, find, Descriptor, MatchOptions };
}
export { match };
...
declare namespace models {
  export { validateModel, KernelOps, ModelStats, Models };
}
export { models };
...
export declare type SegmentationEnum =
  | "default"
  | "alpha"
  | "foreground"
  | "state";
...
declare function validateModel(
  instance: Human | null,
